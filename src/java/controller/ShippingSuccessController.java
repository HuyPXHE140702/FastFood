 ...
 * @author Admin
 */
public class ShippingSuccessController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        float totalprice = orderDAO.getTotalPriceByOrderId(orderID);
        float deliveryMoney = shipper.getDeliverymoney() + totalprice;

        shipperDAOImpl.UpdateDeliveryMoney(deliveryMoney, accountid);

        orderDAO.UpdateStatusBackNull(orderID);
